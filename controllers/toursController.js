...
exports.handleGetTours = catchAsync(async (req, res, next) => {
...
exports.handlePostTours = catchAsync(async (req, res, next) => {
  // const tour = req.body; //json object
...
exports.handlePatchTour = catchAsync(async (req, res, next) => {
